								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="<?= base_url(); ?>single-product"><img class="img-responsive " src="<?= base_url(); ?>public/images/r.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="<?= base_url(); ?>single-product">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="<?= base_url(); ?>single-product"><img class="img-responsive " src="<?= base_url(); ?>public/images/r1.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="<?= base_url(); ?>single-product">Duis aute irure </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="<?= base_url(); ?>single-product"><img class="img-responsive " src="<?= base_url(); ?>public/images/r2.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="<?= base_url(); ?>single-product">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="<?= base_url(); ?>single-product"><img class="img-responsive " src="<?= base_url(); ?>public/images/r3.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="<?= base_url(); ?>single-product">Ut enim ad minim </a></h6>
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="<?= base_url(); ?>public/images/img1.jpg" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="<?= base_url(); ?>public/images/img2.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i2.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i1.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i4.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i3.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i6.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i5.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i8.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i7.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i10.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i9.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i12.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i11.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i14.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="<?= base_url(); ?>public/images/i13.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
