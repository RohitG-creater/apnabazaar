...
<head>
    <title>New Shop a E-Commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Single ::
        w3layouts</title>
    <!--css-->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="<?= base_url('public/css/jstarbox.css') ?>" type="text/css" media="screen"
        charset="utf-8" />
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3  multi-gd-img">
                                                    <ul class="multi-column-dropdown">
                                                        <h6>Submenu1</h6>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Clothing</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Wallets</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Shoes</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Watches</a>
                                                        </li>
                                                        <li><a href="<?= base_url('category-women/product'); ?>">
                                                                Underwear </a></li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Accessories</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-3  multi-gd-img">
                                                    <ul class="multi-column-dropdown">
                                                        <h6>Submenu2</h6>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Sunglasses</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Wallets,Bags</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Footwear</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Watches</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?= base_url('category-women/product'); ?>">Jewellery</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-3  multi-gd-img">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3  multi-gd-img">
                                                    <ul class="multi-column-dropdown">
                                                        <h6>Submenu1</h6>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Clothing</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Wallets</a>
                                                        </li>
                                                        <li><a href="<?= base_url('category-men/product'); ?>">Shoes</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Watches</a>
                                                        </li>
                                                        <li><a href="<?= base_url('category-men/product'); ?>">
                                                                Underwear </a></li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Accessories</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-3  multi-gd-img">
                                                    <ul class="multi-column-dropdown">
                                                        <h6>Submenu2</h6>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Sunglasses</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Wallets,Bags</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Footwear</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Watches</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?= base_url('category-men/product'); ?>">Jewellery</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-3  multi-gd-img">
                ...
                <div class="single-grids">
                        ...
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <?php $image_array = explode(",",$single_product->Product_Image); 
																	foreach($image_array as $image) { ?>
                                     
										<li data-thumb="<?= base_url('public/images/'.$image); ?>">
                                            <div class="thumb-image"> <img src="<?= base_url('public/images/'.$image); ?>"
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">$ <?= $single_product->Product_Offer_Price; ?></p>
                                <div class="description">
                                    <p><span>Quick Overview </span> <?= $single_product->Product_Description; ?></p>
                                </div>
                    ...
                    <div class="col-md-3 single-grid1">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive "
                                        src="<?= base_url(); ?>public/images/r.jpg" alt=""></a>
                            </div>
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive "
                                        src="<?= base_url(); ?>public/images/r1.jpg" alt=""></a>
                            </div>
                            <div class="recent-right">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive "
                                        src="<?= base_url(); ?>public/images/r2.jpg" alt=""></a>
                            </div>
                            <div class="recent-right">
                                <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                                <div class="block">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive "
                                        src="<?= base_url(); ?>public/images/r3.jpg" alt=""></a>
                            </div>
                            <div class="recent-right">
                ...
                <div class="product-w3agile">
                    ...
                    <div class="product-grids">
                        <div class="col-md-4 product-grid">
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive "
                                                    src="<?= base_url(); ?>public/images/r4.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                                            <div class="block">
                                    ...
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive "
                                                    src="<?= base_url(); ?>public/images/r5.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
                                            <div class="block">
                            ...
                            <img class="img-responsive " src="<?= base_url(); ?>public/images/woo2.jpg" alt="">
                        </div>
                                            ...
                                            <div class="descr">
                                                ...
                                                <ul>
                                                    ...
                                                    <li> Material : Outer: 40% Linen &amp; 40% Polyamide; Body Lining:
                                                        100% Cotton; Lining: 100% Acetate</li>
                                                </ul>
                                                <p class="quote">Ut wisi enim ad minim veniam, quis nostrud exerci
                                                    tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo
                                                    consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate
                                            ...
                                            <div class="descr">
                                                <div class="reviews-top">
                                                    <div class="reviews-left">
                                                        <img src="<?= base_url(); ?>public/images/men3.jpg" alt=" "
