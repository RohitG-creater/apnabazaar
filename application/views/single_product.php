							...
							<div clas="single-top">
								<div class="single-left">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="<?= base_url(); ?>public/images/si.jpg">
												<div class="thumb-image"> <img src="<?= base_url(); ?>public/images/si.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="<?= base_url(); ?>public/images/si1.jpg">
												 <div class="thumb-image"> <img src="<?= base_url(); ?>public/images/si1.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="<?= base_url(); ?>public/images/si2.jpg">
											   <div class="thumb-image"> <img src="<?= base_url(); ?>public/images/si2.jpg" data-imagezoom="true" class="img-responsive"> </div>
											</li> 
										 </ul>
									</div>
								</div>
								...
								<div class="col-md-4 product-grid">
									<div id="owl-demo" class="owl-carousel">
										...
										<div class="item">
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="<?= base_url(); ?>public/images/r4.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
													<div class="block">
											...
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="<?= base_url(); ?>public/images/r5.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
													<div class="block">
													...
													<div class="descr">
														<div class="reviews-top">
															<div class="reviews-left">
																<img src="<?= base_url(); ?>public/images/men3.jpg" alt=" " class="img-responsive">
															</div>
