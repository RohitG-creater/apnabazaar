                            ...
                            <ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
                                <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab"
                                        data-toggle="tab" aria-controls="home" aria-expanded="true"><img
                                            src="<?= base_url(); ?>public/images/menu1.png"></a></li>
                                <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab"
                                        aria-controls="profile"><img src="<?= base_url(); ?>public/images/menu.png"></a>
                                </li>
                            </ul>
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home"
                                    ...
                                    <div class="product-tab">
                                        <?php 
												if(isset($men_product) && $men_product != null){ foreach($men_product->result() as $product){ ?>
                                        ...
                                        <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                            <div class="grid-arr">
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            ...
                                                            <div class="grid-img">
                                                                <img src="<?= base_url('public/images/'.$image); ?>"
                                                ...
                                                <div class="women">
                                                    <h6><a href="<?= base_url($product->Product_Url); ?>"
                                                            class="product_text"><?= $product->Product_Name; ?></a></h6>
                                    ...
                                    <div class="product-tab1">
                                                ...
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s2.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s1.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                        ...
                                        <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                            ...
                                            <div class="women">
                                                ...
                                                <span class="size">XL / XXL / S </span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Atqui iste
                                                    locus est, Piso, tibi etiam atque etiam confirmandus, inquam; Refert
                                                    tamen, quo modo. Quod autem meum munus dicis non equidem recuso, sed
                                                    te adiungo socium. </p>
                                                ...
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s4.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s3.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                ...
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s6.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s5.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                ...
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s8.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s7.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                ...
                                                <div class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal"
                                                            data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s10.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img src="<?= base_url(); ?>public/images/s9.jpg"
                                                                    class="img-responsive" alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
